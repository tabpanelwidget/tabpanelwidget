  ...
  div
    ...
    #test-container(:style="{fontSize: fontSize+'px', '--space': space, fontWeight: fontWeight}")
      ...
      div(ref="vueSection")
        ...
        h4 Mode
        div
          input#vue-unspecified(type="radio" v-model="vueMode" :value="undefined")
          label(for="vue-unspecified")  unspecified (dynamic)
          input#vue-accordion(type="radio" v-model="vueMode" value="accordion")
          label(for="vue-accordion") strictly accordion
          input#vue-tabpanel(type="radio" v-model="vueMode" value="tabpanel")
          label(for="vue-tabpanel") strictly tabpanel
        h4 Pick a style
